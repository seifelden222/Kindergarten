    <div class="sticky top-0 z-50 bg-white/90 dark:bg-[#322820]/90 backdrop-blur-md shadow-lg border-b-4 border-primary/30">
            ...
            <div class="flex justify-between items-center gap-4">
                ...
                <div class="hidden md:flex gap-6 lg:gap-10">
                    <a href="{{route('child.home')}}" class="flex flex-col items-center gap-2 group">
                        <div class="bg-primary/10 group-hover:bg-primary/30 p-5 rounded-3xl transition-all shadow-md group-hover:scale-110">
