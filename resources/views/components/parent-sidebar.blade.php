        <aside class="w-72 bg-white dark:bg-[#1a2e1a] border-l border-[#dce5dc] dark:border-[#2d402d] flex flex-col justify-between p-6 overflow-y-auto">
            <div class="flex flex-col gap-8">
                ...
                <nav class="flex flex-col gap-2">
                    <a class="flex items-center gap-3 px-4 py-3 rounded-xl text-[#638863] dark:text-[#a3c2a3] hover:bg-gray-100 dark:hover:bg-white/5 transition-colors" href="{{route('parent.parentdashboard')}}">
                        <span class="material-symbols-outlined">dashboard</span>
                        <span class="text-sm">الرئيسية</span>
                    </a>
                    <a class="flex items-center gap-3 px-4 py-3 rounded-xl bg-primary/10 text-[#111811] dark:text-primary font-bold" href="{{route('parent.activities')}}">
                        <span class="material-symbols-outlined">auto_stories</span>
                        <span class="text-sm">الأنشطة</span>
                    </a>
                    <a class="flex items-center gap-3 px-4 py-3 rounded-xl text-[#638863] dark:text-[#a3c2a3] hover:bg-gray-100 dark:hover:bg-white/5 transition-colors" href="{{route('parent.absence')}}">
                        <span class="material-symbols-outlined">calendar_month</span>
                        <span class="text-sm">الحضور والغياب</span>
                    </a>
                    <a class="flex items-center gap-3 px-4 py-3 rounded-xl text-[#638863] dark:text-[#a3c2a3] hover:bg-gray-100 dark:hover:bg-white/5 transition-colors" href="{{route('parent.notification')}}">
                    ...
                    <a class="flex items-center gap-3 px-4 py-3 rounded-xl text-[#638863] dark:text-[#a3c2a3] hover:bg-gray-100 dark:hover:bg-white/5 transition-colors" href="{{route('parent.messages')}}">
